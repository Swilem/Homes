...
define(['extm'], function(Extm) {
  ...
  mainView = (function(_super) {
    ...
    mainView.prototype.template = '<div id="notify" class="notifyBox" style="display:none;"> You have clicked on a box! </div> <!--<div>dfsfsfs</div>--> <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2"> <h3>My Menu</h3> <ul> <li><a href="#"><span class="glyphicon glyphicon-heart"></span> Wishlist</a> <div id="comparetext" class="compareTxt"> Compare Apartments here!<br>You can compare up to 4 apartments. </div><input type="hidden" name="currency_main" id="currency_main" class="demo" data-a-sign="Rs. " data-m-dec=""  data-d-group="2" > <ul class="menuWishlist" id="showWishlist"> </ul> </li> <a href="#" id="compare" class="compareBtn">COMPARE</a> </ul> </nav> <div class="prntLoader hidden"></div> <div id="screen-one-region" class="section"> </div> <div id="screen-two-region" > </div> <div id="screen-three-region" > </div> <div id="screen-four-region" > </div> <div id="print-view" class="visible-print"> <div class="print-header"> <div class="row print-head"> <div class="col-sm-6 head"> <h1>Flat No: <strong><span id="flatno"></span></strong></h1> </div> <div class="col-sm-6 head"> <h1 id="towerno"></h1> </div> </div> <div class="row print-sub-head"> <div class="col-sm-6 head"> <h2>Flat Type: <strong><span id="unittypename"></span></strong>(<span id="area"></span> sq. ft.)</h2> </div> <div class="col-sm-6 head"> <h2>Floor Range: <strong><span id="floorrise"></span></strong></h2> </div> </div> </div> <div class="print-row"> <div class="row"> <div class="col-sm-5"> <div id="printmapplic1" class="towersMap center-block"></div> </div> <div class="col-sm-7"> <img src="" id="zoomedinimage" /> </div> </div> <div class="row"> <div class="col-sm-5"> <div id="towerview" ></div> </div> <div class="col-sm-7"> <img src="" id="threeDimage" /> </div> </div> </div> <div class="print-row areaInfo"> <div class="row"> <div class="col-sm-12"> <div class="details room"> </div> </div> </div> <div class="row extra-details"> <div class="col-sm-4"> <h5>Terrace</h5> <h6 id="terrace"></h6> </div> <div class="col-sm-4"> <h5>Entrance</h5> <h6 id="printfacing"></h6> </div> <div class="col-sm-4"> <h5>Views</h5> <h6 id="printview"></h6> </div> </div> </div> <div class="costsheetPrint special"> <div class="this-is"> <h3 class="light">Estimated Cost for Flat No. <span class="text-primary flatno"></span> in <span class="text-primary building"></span></h3> </div><!-- invoice headline --> <div class="row"> <div class="col-sm-3"> <h5>Prepared for:</h5> <span id="customerlabel" ></span> </div> <div class="col-sm-3"> <h5>Prepared by:</h5> <h4 class="preparedby"></h4> </div> <div class="col-sm-3"> </div> <div class="col-sm-3"> <h5>Prepared on:</h5> <h4 class="preparedon"></h4> </div> </div> <div class="row"> <div class="col-sm-4"> <h5 >Total Cost:</h5> <h4><span class="actualcost" data-a-sign="Rs. " data-d-group="2"></span></h4> </div> <div class="col-sm-4"> <h5>Current Milestone:</h5> <h4> <span class="currentmile"></span></h4> </div> <div class="col-sm-4"> <h5 >Amount Receivable as on Date:</h5> <h4><span class="rec" data-a-sign="Rs. " data-d-group="2"></span></h4> </div> </div> <div class="row"> <div class="col-sm-4"> <h5>Payment Plan: </h5> <h4><span class="paymentplan"></span></h4> </div> <div class="col-sm-4"> <h5>Actual Payment:</h5> <span class="actpayment" data-a-sign="Rs. " data-d-group=""></span></h4> </div> <div class="col-sm-4"> </div> </div> <div id="costSheetTableprint"> </div> <div class="invoice-items"> <h4 class="text-primary">Payment Schedule</h4> <ul id="paymentTableprint"> </ul> </div> </div> </div>';
