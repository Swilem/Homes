    ...
    ScreenFourLayout.prototype.showWishList = function() {
      ...
      if ($.cookie("key") !== void 0 && $.cookie("key") !== "") {
        ...
        for (_i = 0, _len = selectedUnitsArray.length; _i < _len; _i++) {
          ...
          table += '<li> <a href="#" id="unit' + element + '" data-id="' + element + '" class="selectedunit">' + model.get('name') + ' -' + building.get('name') + ' - ' + unitVariant.get('name') + ' - ' + currency + '</a> <a href="#" class="del" id="' + element + '" data-id="' + element + '"  ></a> <div class="clearfix"></div> </li>';
        }
      }
    ...
    ScreenFourLayout.prototype.generatePaymentSchedule = function(id) {
      ...
      if (paymentColl.length !== 0) {
        ...
        for (index = _i = 0, _len = milestonesArray.length; _i < _len; index = ++_i) {
          ...
          table += '  <span class="msPercent">' + element.payment_percentage + '%</span> <li class="milestoneList ' + trClass + '"> <div class="msName">' + milestoneModel.get('name') + '</div> <div class="msVal discCol' + discountClass + '"> <div class="percentageValue' + index + '" data-m-dec="" data-a-sign="Rs. " data-d-group="2"></div> <div class="service' + index + '" data-m-dec="" data-a-sign="Rs. " data-d-group="2"></div> <div class="total' + index + '" data-m-dec="" data-a-sign="Rs. " data-d-group="2"></div> </div> <div class="msVal"> <div class="percentageValue1' + index + '" data-m-dec="" data-a-sign="Rs. " data-d-group="2"></div> <div class="service1' + index + '" data-m-dec="" data-a-sign="Rs. " data-d-group="2"></div> <div class="total1' + index + '" data-m-dec="" data-a-sign="Rs. " data-d-group="2"></div> </div> <span class="barBg" style="width:' + element.payment_percentage + '%"></span> </li> <div class="clearfix"></div>';
        }
