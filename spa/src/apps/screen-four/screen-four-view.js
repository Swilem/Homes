...
define(['marionette'], function(Marionette) {
  ...
  ScreenFourLayout = (function(_super) {
    ...
    ScreenFourLayout.prototype.generateCostSheet = function() {
      ...
      persefttext = "";
      for (index = _i = 0, _len = persq.length; _i < _len; index = ++_i) {
        element = persq[index];
      ...
      infratxt = '';
      for (index = _j = 0, _len1 = infraArray.length; _j < _len1; index = ++_j) {
      ...
      if (paymentColl.length !== 0) {
        ...
        count = 0;
        for (_k = 0, _len2 = milestonesArray.length; _k < _len2; _k++) {
          element = milestonesArray[_k];
    ...
    ScreenFourLayout.prototype.generatePaymentSchedule = function(id) {
      ...
      if (paymentColl.length !== 0) {
        ...
        for (index = _j = 0, _len1 = milestonesArray.length; _j < _len1; index = ++_j) {
          ...
          _results.push($('.total1' + index).autoNumeric('set', total1));
        }
        return _results;
      }
    };
