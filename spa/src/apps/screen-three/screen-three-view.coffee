define [ 'marionette' ], ( Marionette )->
    ...
    class unitChildView extends Marionette.ItemView
        ...
        template : '<div class="pull-left light">
                        <h5 class="rangeName bold m-t-5">{{name}} : <span class="small">Floor {{floor}}</span> : <span class="small">{{unittypename}} {{sellablearea}} {{sqft}} {{currency}}</span></h5>
                    </div>
