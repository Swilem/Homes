...
define(['marionette'], function(Marionette) {
  ...
  ScreenThreeLayout = (function(_super) {
    ...
    ScreenThreeLayout.prototype.loadtooltip = function(evt) {
      var SVGDocument, SVGRoot, TrueCoords, tipBox, tipDesc, tipText, tipTitle, toolTip;
      ...
      return SVGRoot.addEventListener('mousemove', ShowTooltip, false);
    };
  ...
  unitChildView = (function(_super) {
    ...
    unitChildView.prototype.template = '<div class="pull-left light"> <h5 class="rangeName bold m-t-5">{{name}} : <span class="small">Floor {{floor}}</span> : <span class="small">{{unittypename}} {{sellablearea}} {{sqft}} {{currency}}</span></h5> </div> <input type="hidden" id="flag{{id}}" name="flag{{id}}" value="0"/> <input type="hidden" id="select{{id}}" name="select{{id}}" value="0"/> <div class="clearfix"></div>';
    ...
    unitChildView.prototype.onShow = function() {
      var body, flag, menuRight, myArray, obj, showRightPush, track;
