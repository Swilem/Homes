define [ 'extm', 'src/apps/screen-one/screen-one-view' ], ( Extm, ScreenOneView )->
    ...
    class ScreenTwoController extends Extm.RegionController
        ...
        showUpdateBuilding:(id)=>
            ...
            itemview1 = new ScreenOneView.UnitTypeChildView
                collection : @Collection[0]

            itemview2 = new ScreenOneView.UnitTypeView
                collection : @Collection[1]
        ...
        getView:(buildingCollection)->
            new ScreenOneView.UnitTypeChildView
                collection : buildingCollection

        getUnitsView:(unitCollection)->
            new ScreenOneView.UnitTypeView
