...
define(['extm', 'src/apps/screen-one/screen-one-view'], function(Extm, ScreenOneView) {
  ...
  ScreenTwoController = (function(_super) {
    ...
    ScreenTwoController.prototype.initialize = function() {
      ...
      this.layout = new ScreenOneView.ScreenTwoLayout({
    ...
    ScreenTwoController.prototype.getView = function(buildingCollection) {
      return new ScreenOneView.UnitTypeChildView({
        collection: buildingCollection
      });
    };

    ScreenTwoController.prototype.getUnitsView = function(unitCollection) {
      return new ScreenOneView.UnitTypeView({
  ...
  return msgbus.registerController('screen:one', ScreenTwoController);
});
