   ...
   class ScreenOneView extends Marionette.ItemView
   		...
   		template :'<div class="row">
						...
						<div class="col-md-6">
							...
							<a href="http://homes.skyiapartment.wpengine.com/wp-login.php?wpe-login=skyiapartment&amp;action=wordpress_social_authenticate&amp;mode=login&amp;provider=Google&amp;redirect_to=http%3A%2F%2Fhomes.skyiapartment.wpengine.com%2Fbooking%2F" class="sc-btn sc--small sc--google-plus">
									  <span class="sc-icon">
									...
									<a  href="http://homes.skyiapartment.wpengine.com/wp-login.php?wpe-login=skyiapartment&amp;action=wordpress_social_authenticate&amp;mode=login&amp;provider=Facebook&amp;redirect_to=http%3A%2F%2Fhomes.skyiapartment.wpengine.com%2Fbooking%2F" class="sc-btn sc--small sc--facebook">
									  <span class="sc-icon">
